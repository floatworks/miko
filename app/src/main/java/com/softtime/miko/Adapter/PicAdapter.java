...
public class PicAdapter extends ArrayAdapter<pic> {
    ...
    public PicAdapter(Context context, int resource, List<pic> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            viewHolder.username=(TextView) view.findViewById(R.id.textView_main_task_title);
            viewHolder.picDesc = (TextView) view.findViewById(R.id.textView_main_task_desc);
